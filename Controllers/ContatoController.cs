...
using web_api_azure_table.Models;

namespace web_api_azure_table.Controllers
{
    [ApiController]
    [Route("Controller")]
    public class ContatoController : ControllerBase
    {
        ...
        public ContatoController(IConfiguration configuration)
        {
            ...
            _tableName = configuration.GetValue<string>("AzureTebleName");
        }

        private TableClient GetTableClient() 
        {
            var serviceCliente = new TableServiceClient(_connectionString);
            var tableClient = serviceCliente.GetTableClient(_tableName);
